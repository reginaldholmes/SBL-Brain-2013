...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/USB_MSD_Btl_StarterKit.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../../linker_scripts/PIC32MX_3XX_to_7XX/usb_msd_btl_sk.ld
...
dist/${CND_CONF}/${IMAGE_TYPE}/USB_MSD_Btl_StarterKit.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   ../../linker_scripts/PIC32MX_3XX_to_7XX/usb_msd_btl_sk.ld
	...
	${MP_CC_DIR}\\pic32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/USB_MSD_Btl_StarterKit.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  
endif
