...
IMAGE_TYPE=debug
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/UART_Btl_Explorer16.X.${IMAGE_TYPE}.elf
else
...
# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1129149022/Uart.o ${OBJECTDIR}/_ext/1787047461/BootLoader.o ${OBJECTDIR}/_ext/1787047461/NVMem.o ${OBJECTDIR}/_ext/1094924598/Framework.o
...
ifneq ($(OS_CURRENT),$(OS_ORIGINAL))
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/UART_Btl_Explorer16.X.${IMAGE_TYPE}.elf
...
${OBJECTDIR}/_ext/1129149022/Uart.o: ../../Source/Uart/Uart.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1 -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -mips16 -DDEMO_BOARD_EXPLORER_16 -DTRANSPORT_LAYER_UART -I"../../Include/HardwareProfile" -I"../../Include" -I"../../Include/Usb/Stack" -I"../../Include/FrameWork" -I"../.." -I"../../Include/Usb" -I"../../Include/Uart" -I"../../Include/Framework" -Os -MMD -MF ${OBJECTDIR}/_ext/1129149022/Uart.o.d -o ${OBJECTDIR}/_ext/1129149022/Uart.o ../../Source/Uart/Uart.c  
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	 sed -e 's/\\$$/__EOL__/g' -e 's/\\ /__ESCAPED_SPACES__/g' -e 's/\\/\//g' -e 's/__ESCAPED_SPACES__/\\ /g' -e 's/__EOL__$$/\\/g' ${OBJECTDIR}/_ext/1129149022/Uart.o.d > ${OBJECTDIR}/_ext/1129149022/Uart.o.tmp
	${RM} ${OBJECTDIR}/_ext/1129149022/Uart.o.d 
	${CP} ${OBJECTDIR}/_ext/1129149022/Uart.o.tmp ${OBJECTDIR}/_ext/1129149022/Uart.o.d 
	${RM} ${OBJECTDIR}/_ext/1129149022/Uart.o.tmp
endif
...
${OBJECTDIR}/_ext/1129149022/Uart.o: ../../Source/Uart/Uart.c  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR}/_ext/1129149022 
	${RM} ${OBJECTDIR}/_ext/1129149022/Uart.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE)  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -mips16 -DDEMO_BOARD_EXPLORER_16 -DTRANSPORT_LAYER_UART -I"../../Include/HardwareProfile" -I"../../Include" -I"../../Include/Usb/Stack" -I"../../Include/FrameWork" -I"../.." -I"../../Include/Usb" -I"../../Include/Uart" -I"../../Include/Framework" -Os -MMD -MF ${OBJECTDIR}/_ext/1129149022/Uart.o.d -o ${OBJECTDIR}/_ext/1129149022/Uart.o ../../Source/Uart/Uart.c  
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	 sed -e 's/\\$$/__EOL__/g' -e 's/\\ /__ESCAPED_SPACES__/g' -e 's/\\/\//g' -e 's/__ESCAPED_SPACES__/\\ /g' -e 's/__EOL__$$/\\/g' ${OBJECTDIR}/_ext/1129149022/Uart.o.d > ${OBJECTDIR}/_ext/1129149022/Uart.o.tmp
	${RM} ${OBJECTDIR}/_ext/1129149022/Uart.o.d 
	${CP} ${OBJECTDIR}/_ext/1129149022/Uart.o.tmp ${OBJECTDIR}/_ext/1129149022/Uart.o.d 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/UART_Btl_Explorer16.X.${IMAGE_TYPE}.elf: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
...
dist/${CND_CONF}/${IMAGE_TYPE}/UART_Btl_Explorer16.X.${IMAGE_TYPE}.elf: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/UART_Btl_Explorer16.X.${IMAGE_TYPE}.elf ${OBJECTFILES}        -Wl,--defsym=__MPLAB_BUILD=1,--report-mem$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--gc-sections,-L"../../MPLAB_Workspace",-Map="$(BINDIR_)$(TARGETBASE).map"
	${MP_CC_DIR}\\pic32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/UART_Btl_Explorer16.X.${IMAGE_TYPE}.elf  
endif
