...
//#define BOOTLOAD_TIMEOUT 500000000L
#define BOOTLOAD_TIMEOUT 5500000L
long bootLoadTimeOut;
...
#define USER_APP_RESET_ADDRESS 	0x9D004700

//Setup IO PINS for reading skip bootload jumper
  #define PGD_TRIS TRISBbits.TRISB0 //input
  #define PGD_PU CNPUBbits.CNPUB0 	//pullup on
  #define PGD_IN PORTBbits.RB0

  #define PGC_OUT LATBbits.LATB1
